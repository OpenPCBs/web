...
export default async function LabPage({ searchParams }: { searchParams: LabSearchParams }) {
  ...
  return <><SiteHeader active="lab" /><DivisionBanner /><main>
    <section className="page-hero shell split-hero"><div><span className="kicker">PAID · REVISION-BOUND · EVIDENCE-BACKED</span><h1>Verification that means<br />something specific.</h1><p>Thevenin Verification Lab is a charged engineering service. We reproduce a locked design revision, test it under an agreed method, and publish exactly what passed, failed, or remained outside scope.</p><div className="hero-actions"><a className="button" href="#pricing">View service levels <span>↓</span></a><a className="text-link" href="#deliverables">See report contents <span>↗</span></a></div></div><div className="lab-instrument"><div className="instrument-top"><span>THEVENIN LAB / RUN 0248</span><span className="live-dot">TESTING</span></div><div className="waveform"><i /><i /><i /><i /><span>V<sub>DS</sub></span></div><div className="instrument-readings"><div><span>Efficiency</span><b>97.82%</b></div><div><span>Output</span><b>48.01 V</b></div><div><span>Thermal</span><b>62.4 °C</b></div></div></div></section>
